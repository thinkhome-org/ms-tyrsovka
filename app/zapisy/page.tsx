                ...
                <div className="flex flex-wrap items-end justify-between gap-4">
                    <div>
                        ...
                        <p className="mt-3 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg">
                            Placeholder stránka – doplníme informace k zápisům
                            později.
                        </p>
                    </div>
                ...
                <Card className="mt-10 border-border/70 bg-card/90">
                    <CardContent className="p-6 sm:p-8">
                        <p className="leading-relaxed text-muted-foreground">
                            Sem pak dáme termíny, dokumenty ke stažení a postup
                            přihlášení. Teď je to jen kostra stránky, aby
                            tlačítko mělo kam vést.
                        </p>
                    </CardContent>
                </Card>
            </div>
